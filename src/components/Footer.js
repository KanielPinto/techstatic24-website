        ...
        <footer>
            <div className="footer-container">
                <div className="text-container">
                    <div className="team">
                        <h4>Made by the Techstatic 2024 Developments Team</h4>
                    </div>
                    <div className="techstatic-copyright">
                        <h4>Techstatic &copy;</h4>
                    </div>
                </div>
                <div className="socials-svgs">
                    <div className="instagram">
                        <a href="https://www.instagram.com/techstatic.sxc/">
                    ...
                    <div className="threads">
                        <a href="#">
                            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-threads" viewBox="0 0 16 16">
                    ...
                    <div className="linkedIn">
                        <a href="https://www.linkedin.com/in/techstatic-fest-6aa8332a6/">
